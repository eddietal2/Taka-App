...
const en = {
  ...
  'switchRole.title': 'Switching account',
  'switchRole.message': 'Setting up your {role} account…',
  'switchRole.failedTitle': 'Could not switch account',
  'switchRole.failed': 'Check your connection and try again.',
  'switchRole.retry': 'Try again',
...
const sw: Record<TranslationKey, string> = {
  ...
  'switchRole.title': 'Inabadilisha akaunti',
  'switchRole.message': 'Tunapanga akaunti yako ya {role}…',
  'switchRole.failedTitle': 'Imeshindwa kubadilisha akaunti',
  'switchRole.failed': 'Angalia muunganisho wako na ujaribu tena.',
  'switchRole.retry': 'Jaribu tena',
